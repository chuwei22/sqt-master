...
const update_grid = function () {
    ...
    const ghost_game = R.reduce(Tetris.soft_drop_ghost, game, R.range(0, 22));
    ...
    game.score.level = Score.level(game.score);

    // display the score information.
    document.getElementById("score").innerHTML = game.score.score;
    document.getElementById("lines").innerHTML = game.score.lines_cleared;
    document.getElementById("level").innerHTML = game.score.level;
...
const timer_function = function () {
    ...
    update_grid();
    setTimeout(timer_function, 2500 / (game.score.level + 4));
};
